...
public class JavaOCLRenderEngine {
	private static String programtitle = "Java OpenCL Render Engine v1.0.7.4";
	...
	public void render() {
		...
		computelib.insertBarrier(queue);
		computelib.runProgram(opencldevice, queue, program, "renderplaneview", new long[]{graphicsbufferptr,graphicszbufferptr,graphicshbufferptr,camposbufferptr,cammovbufferptr,tri3ptr,tri3lenptr,tex3ptr,tex3lenptr,obj3ptr,obj3lenptr}, new int[]{0,0}, new int[]{graphicswidth,4});
		computelib.insertBarrier(queue);
